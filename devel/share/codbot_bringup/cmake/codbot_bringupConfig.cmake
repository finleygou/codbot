...
if("TRUE" STREQUAL "TRUE")
  set(codbot_bringup_SOURCE_PREFIX /home/codbot/codbot_ws/src/codbot_sensor/codbot_bringup)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'shqfeng <shqfeng@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'codbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/codbot/codbot_ws/src/codbot_sensor/codbot_bringup/${idir}'.  ${_report}")
    endif()
